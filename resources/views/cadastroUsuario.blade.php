...
<body>
    ...
    <div class="login-container">
        ...
        <!-- Formulário -->
        <form action="{{ route('usuario.cadastro.post') }}" method="POST">
            @csrf
            <!-- Nome -->
            <div class="mb-3">
            ...
            <!-- Texto alternativo -->
            <p class="text-center" style="color: #ed1c24;">Já tem uma conta? <a href="/login" style="text-decoration: none; color: #d4171d;">Entre aqui</a></p>
        </form>
    </div>
